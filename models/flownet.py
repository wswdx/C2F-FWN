...
# class for flownet which estimates optical flows for us
class FlowNet(BaseModel):
    ...
    def initialize(self, opt):
        ...
        checkpoint = torch.load('models/flownet2_pytorch/FlowNet2_checkpoint.pth.tar', map_location=torch.device('cpu'))
