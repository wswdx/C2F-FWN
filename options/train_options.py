...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        #for clotbwarperloss
        self.parser.add_argument('--lambda_structure', type=float, default=10.0, help='weight for total flow warp (layout)')        
        self.parser.add_argument('--lambda_flow', type=float, default=1.0, help='weight for optical flow warp')        
        self.parser.add_argument('--lambda_smooth', type=float, default=2.0, help='weight for flow smoothness')       

        #for parser
        self.parser.add_argument('--lambda_P', type=float, default=10.0, help='weight for pixelwise softmax crossentropy loss')       
        ...
        self.parser.add_argument('--lambda_F', type=float, default=5.0, help='weight for flow loss')
