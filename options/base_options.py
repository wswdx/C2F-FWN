...
class BaseOptions():
    ...
    def initialize(self):                
        ...
        #new options
        self.parser.add_argument('--input_nc_T_1', type=int, default=16, help='')
        self.parser.add_argument('--input_nc_T_2', type=int, default=11, help='# of input T channels (TPose, TLO, TFG)')
        self.parser.add_argument('--input_nc_T_3', type=int, default=19, help='')
        self.parser.add_argument('--input_nc_S_1', type=int, default=3, help='')
        self.parser.add_argument('--input_nc_S_2', type=int, default=8, help='')
        self.parser.add_argument('--input_nc_S_3', type=int, default=16, help='')
        self.parser.add_argument('--input_nc_P_1', type=int, default=10, help='')
        self.parser.add_argument('--input_nc_P_2', type=int, default=20, help='')
        self.parser.add_argument('--label_nc_1', type=int, default=13, help='')
        self.parser.add_argument('--label_nc_2', type=int, default=5, help='')
        self.parser.add_argument('--label_nc_3', type=int, default=13, help='')
        self.parser.add_argument('--output_nc_1', type=int, default=13, help='')
        self.parser.add_argument('--output_nc_2', type=int, default=2, help='')
        self.parser.add_argument('--output_nc_3', type=int, default=3, help='')
        self.parser.add_argument('--n_downsample_warper', type=int, default=4, help='number of downsampling layers in warper')        
        self.parser.add_argument('--grid_size', type=int, default=3, help='grid size for tps warper')        
        self.parser.add_argument('--fine_height', type=int, default=256, help='output height')        
        self.parser.add_argument('--fine_width', type=int, default=192, help='output width')        
        self.parser.add_argument('--tps_only', action='store_true', help='only learn the tps warp at the beginning')        
        ...
        self.parser.add_argument('--color_aug', action='store_true', help='if specified, do color argumentation when preparing data')                    
